...
public class NameToStructureConfig {
	...
	private NameToStructureConfig() {
	}

//	private boolean allowRadicals;
...
//	
//	/**
//	 * Returns a NameToStructureConfig with the following sensible settings:
//	 * allowRadicals = false
//	 * slackSpaceHandling = true
//	 * substituentAbbreviations = true
//	 * ignoreStereochemistry = false
//	 * ignoreCurrentlyUninterpretableStereochemistry = true
//	 * 
//	 * Note that these are the settings that are used if no config is specified
//	 */
...
//		n2sConfig.substituentAbbreviations = true;
...
//	 */
//	public static NameToStructureConfig getStrictIupactConfigInstance() {
//		NameToStructureConfig n2sConfig = new NameToStructureConfig();
//		n2sConfig.allowRadicals = false;
//		n2sConfig.slackSpaceHandling = true;
//		n2sConfig.substituentAbbreviations = true;
